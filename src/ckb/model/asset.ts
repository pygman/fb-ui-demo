...
import { SerializeForceBridgeLockscriptArgs } from '../generated/force_bridge_lockscript';
...
export abstract class Asset {
  public chainType: ChainType = ChainType.ETH;
  ...
  protected constructor(ownerCellTypeHash?: string) {
    ...
    this.ownerCellTypeHash = ForceBridgeCoreCkb.utils.scriptToHash(<CKBComponents.Script>{
  ...
  public toTypeScript(): ScriptLike {
    ...
    return new ScriptLike(
      ...
      ForceBridgeCoreCkb.utils.scriptToHash(bridgeCellLockscript as CKBComponents.Script),
      ForceBridgeCore.config.ckb.deps.sudtType.script.hashType as 'data' | 'type' | 'data1',
    );
  }
